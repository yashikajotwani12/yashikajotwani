...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 sm:px-12 lg:px-24 py-4 transition-all duration-300 ${
          scrolled || menuOpen
            ? "glass border-b border-white/20 dark:border-white/5"
            : "bg-transparent"
        }`}
      >
        <Link
      ...
      {/* Mobile menu overlay */}
      {menuOpen && (
        <div className="fixed inset-0 z-40 pt-16 sm:hidden">
          <div
            className="absolute inset-0 bg-black/20 dark:bg-black/40"
            onClick={() => setMenuOpen(false)}
          />
          <div className="relative mx-4 mt-2 p-4 glass rounded-xl">
            ...
            <div className="mt-4 pt-4 border-t border-white/20 dark:border-white/5 flex items-center gap-4 px-4">
              <a
                href="https://github.com"
                target="_blank"
                rel="noopener noreferrer"
